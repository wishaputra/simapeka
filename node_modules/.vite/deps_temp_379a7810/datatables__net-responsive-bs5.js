...
// node_modules/datatables.net-responsive-bs5/node_modules/datatables.net/js/jquery.dataTables.mjs
  ...
  return function(row, update, render, closeCallback) {
    if (!$3.fn.modal) {
      ...
      if (!update) {
        ...
        if ($3.contains(document, _modal[0]) && row.index() === _modal.data("dtr-row-idx")) {
          _modal.find("div.modal-body").empty().append(render());
        } else {
          return null;
        }
