...
// node_modules/datatables.net-buttons/node_modules/datatables.net/js/jquery.dataTables.mjs
...
var Buttons = function(dt, config) {
  ...
  this.dom = {
    container: $2("<" + this.c.dom.container.tag + "/>").addClass(this.c.dom.container.className)
  };
  this._constructor();
};
$2.extend(Buttons.prototype, {
  ...
  */
  ...
  _expandButton: function(attachTo, button, split, inCollection, inSplit, attachPoint, parentConf) {
    ...
    for (var i = 0, ien = buttons.length; i < ien; i++) {
      ...
      if (built.conf.buttons) {
        built.collection = $2("<" + domCollection.container.content.tag + "/>");
        built.conf._collection = built.collection;
        $2(built.node).append(domCollection.action.dropHtml);
        this._expandButton(
          built.buttons,
          built.conf.buttons,
          built.conf.split,
  ...
  _buildButton: function(config, inCollection, isSplit, inSplit) {
    ...
    if (config.spacer) {
      var spacer = $2("<" + dom.spacer.tag + "/>").addClass("dt-button-spacer " + config.style + " " + dom.spacer.className).html(text(config.text));
      return {
        conf: config,
        node: spacer,
        inserter: spacer,
    ...
    if (!config.hasOwnProperty("html")) {
      ...
      button = $2("<" + tag + "/>").addClass(dom.className).attr("tabindex", this.s.dt.settings()[0].iTabIndex).attr("aria-controls", this.s.dt.table().node().id).on("click.dtb", function(e) {
        e.preventDefault();
      ...
      if (dom.liner.tag) {
        var liner = $2("<" + dom.liner.tag + "/>").html(text(config.text)).addClass(dom.liner.className);
  ...
  _popover: function(content, hostButton, inOpts, e) {
    ...
    var close = function() {
      ...
      $2(dt.buttons('[aria-haspopup="dialog"][aria-expanded="true"]').nodes()).attr(
        "aria-expanded",
        "false"
      );
    ...
    if (position === "absolute") {
      ...
      if (containerPosition.top + top < $2(window).scrollTop()) {
    ...
    $2("div.dt-button-background").on("click.dtb-collection", function() {
    });
    ...
    setTimeout(function() {
      closed = false;
      $2("body").on("click.dtb-collection", function(e2) {
        if (closed) {
          return;
        }
        var back = $2.fn.addBack ? "addBack" : "andSelf";
        var parent = $2(e2.target).parent()[0];
        if (!$2(e2.target).parents()[back]().filter(content).length && !$2(parent).hasClass("dt-buttons") || $2(e2.target).hasClass("dt-button-background")) {
          close();
        }
        ...
        var elements = $2("a, button", content);
...
jquery_dataTables_default.Api.register("buttons.info()", function(title, message, time) {
  ...
  _fadeIn(
    $2('<div id="datatables_buttons_info" class="dt-button-info"/>').html(title).append($2("<div/>")[typeof message === "string" ? "html" : "append"](message)).css("display", "none").appendTo("body")
  );
...
var _filename = function(config) {
  ...
  if (filename.indexOf("*") !== -1) {
    filename = filename.replace("*", $2("head > title").text()).trim();
  }
...
var _title = function(config) {
  ...
  return title === null ? null : title.indexOf("*") !== -1 ? title.replace("*", $2("head > title").text() || "Exported data") : title;
};
...
datatables.net-buttons/js/dataTables.buttons.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-CKUE7RQD.js.map
