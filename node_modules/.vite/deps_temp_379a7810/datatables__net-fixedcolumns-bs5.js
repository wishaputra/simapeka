...
// node_modules/datatables.net-fixedcolumns-bs5/node_modules/datatables.net/js/jquery.dataTables.mjs
...
// node_modules/datatables.net-fixedcolumns/node_modules/datatables.net/js/jquery.dataTables.mjs
...
(function() {
  ...
  setJQuery($4);
  $4.fn.dataTable.FixedColumns = FixedColumns;
  $4.fn.DataTable.FixedColumns = FixedColumns;
  ...
  jquery_dataTables_default2.ext.buttons.fixedColumns = {
    action: function(e, dt, node, config) {
      if ($4(node).attr("active")) {
        $4(node).removeAttr("active").removeClass("active");
        dt.fixedColumns().left(0);
        dt.fixedColumns().right(0);
      } else {
        $4(node).attr("active", "true").addClass("active");
  ...
  function _init(settings, options) {
    ...
    var opts = options ? options : api.init().fixedColumns || jquery_dataTables_default2.defaults.fixedColumns;
    var fixedColumns = new FixedColumns(api, opts);
    return fixedColumns;
  }
  $4(document).on("plugin-init.dt", function(e, settings) {
    if (e.namespace !== "dt") {
      return;
    }
    if (settings.oInit.fixedColumns || jquery_dataTables_default2.defaults.fixedColumns) {
