...
// node_modules/datatables.net-rowgroup-bs5/node_modules/datatables.net/js/jquery.dataTables.mjs
...
// node_modules/datatables.net-rowgroup/node_modules/datatables.net/js/jquery.dataTables.mjs
...
var RowGroup = function(dt, opts) {
  if (!jquery_dataTables_default2.versionCheck || !jquery_dataTables_default2.versionCheck("1.10.8")) {
    throw "RowGroup requires DataTables 1.10.8 or newer";
  }
  this.c = $4.extend(true, {}, jquery_dataTables_default2.defaults.rowGroup, RowGroup.defaults, opts);
  this.s = {
...
$4.extend(RowGroup.prototype, {
  ...
  dataSrc: function(val) {
    ...
    var dt = this.s.dt;
    this.c.dataSrc = val;
    $4(dt.table().node()).triggerHandler("rowgroup-datasrc.dt", [dt, val]);
    return this;
  },
  /**
  ...
  _adjustColspan: function() {
    $4("tr." + this.c.className, this.s.dt.table().body()).find("th:visible, td:visible").attr("colspan", this._colspan());
  },
  /**
  ...
  _group: function(level, rows) {
    ...
    var fn = jquery_dataTables_default2.ext.oApi._fnGetObjectDataFn(fns[level]);
    var dt = this.s.dt;
    var group, last;
    var data = [];
    var that = this;
  ...
  _rowWrap: function(display, className, level) {
    ...
    if (typeof display === "object" && display.nodeName && display.nodeName.toLowerCase() === "tr") {
      row = $4(display);
    } else if (display instanceof $4 && display.length && display[0].nodeName.toLowerCase() === "tr") {
      row = display;
    } else {
      row = $4("<tr/>").append(
        $4("<th/>").attr("colspan", this._colspan()).attr("scope", "row").append(display)
      );
    }
...
$4.fn.dataTable.RowGroup = RowGroup;
$4.fn.DataTable.RowGroup = RowGroup;
jquery_dataTables_default2.Api.register("rowGroup()", function() {
  return this;
});
jquery_dataTables_default2.Api.register("rowGroup().disable()", function() {
  return this.iterator("table", function(ctx) {
    if (ctx.rowGroup) {
...
jquery_dataTables_default2.Api.register("rowGroup().enable()", function(opts) {
  return this.iterator("table", function(ctx) {
    if (ctx.rowGroup) {
...
jquery_dataTables_default2.Api.register("rowGroup().enabled()", function() {
  var ctx = this.context;
  return ctx.length && ctx[0].rowGroup ? ctx[0].rowGroup.enabled() : false;
});
jquery_dataTables_default2.Api.register("rowGroup().dataSrc()", function(val) {
  if (val === void 0) {
...
$4(document).on("preInit.dt.dtrg", function(e, settings, json) {
  if (e.namespace !== "dt") {
    return;
  }
  var init = settings.oInit.rowGroup;
  var defaults = jquery_dataTables_default2.defaults.rowGroup;
  if (init || defaults) {
