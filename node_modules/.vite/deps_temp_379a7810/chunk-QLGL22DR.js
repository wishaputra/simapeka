...
// node_modules/datatables.net-responsive/node_modules/datatables.net/js/jquery.dataTables.mjs
...
var Responsive = function(settings, opts) {
  ...
  this.c = $2.extend(true, {}, Responsive.defaults, jquery_dataTables_default.defaults.responsive, opts);
...
Responsive.renderer = {
  listHiddenNodes: function() {
    return function(api, rowIdx, columns) {
      ...
      var found = false;
      var data = $2.each(columns, function(i, col) {
        if (col.hidden) {
...
$2(document).on("preInit.dt.dtr", function(e, settings, json) {
  ...
  if ($2(settings.nTable).hasClass("responsive") || $2(settings.nTable).hasClass("dt-responsive") || settings.oInit.responsive || jquery_dataTables_default.defaults.responsive) {
...
datatables.net-responsive/js/dataTables.responsive.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-QLGL22DR.js.map
