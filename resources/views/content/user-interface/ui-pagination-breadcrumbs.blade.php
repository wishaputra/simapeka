  ...
  <div class="card-body">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb mb-0">
        <li class="breadcrumb-item">
          <a href="javascript:void(0);" class="d-flex align-items-center"><i class="ri-star-fill me-1 text-body ri-20px"></i>Home</a>
        </li>
        <li class="breadcrumb-item">
          <a href="javascript:void(0);" class="d-flex align-items-center"><i class="ri-star-fill me-1 text-body ri-20px"></i>Library</a>
        </li>
        <li class="breadcrumb-item active">
          <a href="javascript:void(0);" class="d-flex align-items-center"><i class="ri-star-fill me-1 text-heading ri-20px"></i>Data</a>
        </li>
      </ol>
    </nav>
    <!--/ Basic Breadcrumb with icon -->
