    ...
    <div class="card invoice-preview-card p-sm-12 p-6">
            ...
            <dl class="row mb-0 gx-4">
              ...
              <dd class="col-sm-7">
                <div class="input-group input-group-merge input-group-sm">
                  ...
                  <input type="text" class="form-control" placeholder="45678" value="45678" id="invoiceId" />
                </div>
              </dd>
              <dt class="col-sm-5 mb-2 d-md-flex align-items-center justify-content-start">
      ...
      <div class="card-body pt-0 px-0">
        <form class="source-item">
          ...
          <div class="row">
            <div class="col-12">
              <button type="button" class="btn btn-primary btn-sm" data-repeater-create><i class="ri-add-line ri-14px me-1_5"></i> Add Item</button>
            </div>
          </div>
        </form>
      </div>
