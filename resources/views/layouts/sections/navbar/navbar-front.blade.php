  ...
  <div class="navbar navbar-expand-lg landing-navbar border-top-0 px-4 px-md-8">
    ...
    <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto p-4 p-lg-0">
          ...
          <div class="dropdown-menu p-4 p-lg-6">
            <div class="row gy-4">
              ...
              <div class="col-12 col-lg">
                ...
                <ul class="nav flex-column">
                  <li class="nav-item">
                    <a class="nav-link mega-dropdown-link d-flex align-items-center" href="{{url('/auth/login-basic')}}"
                      target="_blank">
                      <i class='menu-icon tf-icons ri-circle-line me-2'></i>
                      Login (Basic)
                    </a>
                  ...
                  <li class="nav-item">
                    <a class="nav-link mega-dropdown-link d-flex align-items-center" href="{{url('/auth/login-cover')}}"
                      target="_blank">
                      <i class='menu-icon tf-icons ri-circle-line me-2'></i>
                      Login (Cover)
                    </a>
              ...
              <div class="col-12 col-lg">
                ...
                <ul class="nav flex-column">
                  <li class="nav-item">
                    <a class="nav-link mega-dropdown-link d-flex align-items-center" href="{{url('/pages/misc-error')}}"
                      target="_blank">
                      <i class='menu-icon tf-icons ri-circle-line me-2'></i>
                      Error
                    </a>
        ...
        <li class="nav-item">
          <!-- <a class="nav-link fw-medium" href="{{url('/auth/login-basic')}}" target="_blank">Admin</a> -->
        </li>
      </ul>
    </div>
